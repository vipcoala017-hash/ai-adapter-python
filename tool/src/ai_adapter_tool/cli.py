        ...
        json.dumps(
            {
                ...
                "ai": {
                    ...
                    "effective_launch_mode": ai_config.effective_launch_mode,
    ...
    (task_dir / "ai-invocation.md").write_text(
        "\n".join(
            [
                ...
                f"- configured_launch_mode: `{invocation.configured_launch_mode}`",
                f"- effective_launch_mode: `{invocation.effective_launch_mode}`",
                "",
                "## Logical CLI",
                "",
                "```text",
